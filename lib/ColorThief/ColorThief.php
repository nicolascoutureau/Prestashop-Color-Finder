...
require_once(dirname(__FILE__) . '/Image/ImageLoader.php');
require_once(dirname(__FILE__) . '/VBox.php');
require_once(dirname(__FILE__) . '/PQueue.php');
require_once(dirname(__FILE__) . '/CMap.php');
